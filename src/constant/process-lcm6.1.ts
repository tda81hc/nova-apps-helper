...
export const PROCESS_LCM6_1 = {
  novaApps: [],
  processData: {
    name: "Type Process Demo 6.1 - LCM",
  ...
  independentPhases: [
    {
      name: "Unlinked Phase Alpha",
      description: "Phase not associated with any milestone (Alpha)",
    },
    {
      name: "Unlinked Phase Beta",
      description: "Phase not associated with any milestone (Beta)",
    },
    {
      name: "Unlinked Phase Gamma",
      description: "Phase not associated with any milestone (Gamma)",
    },
